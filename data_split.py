...
# 预处理输出地址
data_path = "E:\DataSet\Data\output"
...
with open('E:\\DataSet\\Data\\output\\train.txt','w') as f:
    f.write('\n'.join(train_ids))

with open('E:\\DataSet\\Data\\output\\valid.txt','w') as f:
    f.write('\n'.join(val_ids))

with open('E:\\DataSet\\Data\\output\\test.txt','w') as f:
    f.write('\n'.join(test_ids))
